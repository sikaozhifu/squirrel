...
<body>
	<div id="loginbox">
	<h1 style="text-align:center;">中北二手工坊管理系统</h1>
		<form id="loginform" class="form-vertical" action="<%=basePath%>admin/login" method="post" role="form">
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_lg"><i class="icon-user"></i> </span> <input
							type="text"  name="username" id="phone"
