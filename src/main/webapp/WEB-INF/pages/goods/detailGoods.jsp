                ...
                <form action="<%=basePath%>user/addUser" method="POST" role="form" id="signup_form">
                    ...
                    <div class="input-field col s12">
                        <input type="text" name="email" required="required"
                               class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched"/>
                        <a class=" btn red " style="position: relative;top: -50px;left: 264px;"
                           onclick="sendEmail(this)">发送</a>
                        <label>邮箱</label>
                    </div>
                    <div class="input-field col s12">
                        ...
                        <div id="errorCode" style="color:red;display:inline;"></div>
                        </label>
                        <label>验证码</label>
                    </div>
...
<div ng-controller="detailBoxController" class="detail-box stark-components z-depth-1 row ng-scope">
    ...
    <div class="col s6">
        ...
        <div class="item-public-info">
            ...
            <p>
                <i class="iconfont"></i>
                <em class="item-location">${item.goods.user.school}</em>
            </p>
        </div>
        ...
        <c:if test="${!empty cur_user}">
            <div class="item-contact">
                <div>
                    ...
                    <div class="value">${seller.username} &nbsp;&nbsp;&nbsp;&nbsp;<span
                            style="cursor: pointer;color: #0e90d2" onclick="chat(${seller.id})">联系他</span></div>
                </div>
                <div>
                    <div class="base-blue z-depth-1 attr">
                        <i class="iconfont"></i>
