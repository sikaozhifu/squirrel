...
<head>
    ...
    <script>
        ...
        function sendEmail(obj){
            ...
            //发送邮箱
            $.get("<%=basePath%>user/email",{email:email},function (code) {
                $("input[name=code1]").val(code);
            })
        }
        function checkCode(){
        ...
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form action="<%=basePath%>user/addUser" method="POST" role="form" id="signup_form">
                    ...
                    <div class="input-field col s12">
                        <input type="text" name="email" required="required" class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched" />
                        <a class=" btn red " style="position: relative;top: -50px;left: 264px;" onclick="sendEmail(this)">发送</a>
                        <label>邮箱</label>
                    </div>
                    <div class="input-field col s12">
                        <input type="text" name="code" required="required" class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched" onblur="checkCode()" />
                        <input type="hidden" name="code1"/><div id="errorCode" style="color:red;display:inline;"></div></label>
                        <label>验证码</label>
                    </div>

                    <div class="input-field col s12">
                        <input type="text" name="school" required="required" class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched" />
                        <label>学校</label>
                    </div>
                    <div class="input-field col s12">
...
<div class="main-content">
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到中北大学secondHandMarket校园二手工坊。临近毕业季的</p>
                                <p class="text3">你，是否有太多的闲置与校友分享，为了追求更好的校园服</p>
                                <p class="text4">务，我们打造了一个全新的校园平台——<span>中北二手工坊</span></p>
    ...
    <div class="waterfoo stark-components row">
        <div class="item-wrapper normal">
            <c:forEach var="goods" items="${recomments}">
                <div class="card col">
                    <a href="<%=basePath%>goods/goodsId/${goods.id}">
                        <div class="card-image">
                            <img src="<%=basePath%>upload/${goods.imageList[0].imgUrl}" />
                        </div>
                        <div class="card-content item-price"><c:out value="${goods.price}"></c:out></div>
                        <div class="card-content item-name">
                            <p><c:out value="${goods.name}"></c:out></p>
                        </div>
                        <div class="card-content item-location">
                            <p>${goods.user.school}</p>
                            <p><c:out value="${goods.startTime}"></c:out></p>
                        </div>
                    </a>
                </div>
            </c:forEach>
